...
<template>
    ...
    <div class="bg-gray-50 text-black/50 dark:bg-black dark:text-white/50">
        <img id="background" class="absolute -left-20 top-0 max-w-[877px]"
            src="https://www.economx.hu/fototar/fototar/202403/orig/image1709548505.jpg/800/?v=2024012201" />
        <div
            ...
            <div class="relative w-full max-w-2xl px-6 lg:max-w-7xl">
                ...
                <main class="mt-6">
                    <div class="grid gap-6 lg:grid-cols-2 lg:gap-8">
                        <a href="#" id="docs-card"
                            class="flex flex-col items-start gap-6 overflow-hidden rounded-lg bg-transparent p-6    ">
                        ...
                        <a href="https://www.youtube.com/results?search_query=crypto"
                            ...
                            <div class="pt-3 sm:pt-5">
                                ...
                                <p class="mt-4 text-sm/relaxed">
                                    A cryptocurrency, crypto-currency, or crypto[a] is a digital currency designed to
                                    work as a medium
                        ...
                        <a href="https://crypto.news/"
                            ...
                            <div class="pt-3 sm:pt-5">
                                ...
                                <p class="mt-4 text-sm/relaxed">
                                    ...
                                    using strong cryptography to secure transaction records, control the creation of
                                    additional coins,
                                    and verify the transfer of coin ownership..
                                </p>
                            </div>
                        ...
                        <div
                            ...
                            <a
                                href="https://scholar.google.com/scholar?hl=hu&as_sdt=0%2C5&q=cryptocurrency&btnG=&oq=cripto">
                                <div class="pt-3 sm:pt-5">
                                    <h2 class="text-xl font-semibold text-black dark:text-white">
                                        Documentation
                                    </h2>
